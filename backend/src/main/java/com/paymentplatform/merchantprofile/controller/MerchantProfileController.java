...
public class MerchantProfileController {
    ...
    public ResponseEntity<org.springframework.data.domain.Page<MerchantProfileResponseDTO>> listByStatus(@PathVariable MerchantProfileStatus status, Pageable pageable) {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<MerchantProfileResponseDTO>> search(@RequestParam(required = false) String q) {
        return ResponseEntity.ok(merchantProfileService.searchPublic(q));
    }
}
