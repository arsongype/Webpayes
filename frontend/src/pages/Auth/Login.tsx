...
import { Shield, CheckCircle2, Loader2, Lock, Mail, Eye, EyeOff, ArrowRight, Sparkles } from 'lucide-react';
...
// Logo SVG (monogramme WebPaysh)
export const LogoMark = ({ size = 'md' }: { size?: 'sm' | 'md' | 'lg' }) => {
  const sizes = {
  ...
  const s = sizes[size];
  return (
    <div className={`relative flex ${s.box} items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-br from-cyan-400 via-cyan-500 to-blue-600 shadow-lg shadow-cyan-500/30`}>
      ...
      >
        <path
          d="M3 7.5C3 5.567 4.567 4 6.5 4H17.5C19.433 4 21 5.567 21 7.5V11H3V7.5Z"
          fill="currentColor"
          opacity="0.9"
        />
        <path
          d="M3 13H21V16.5C21 18.433 19.433 20 17.5 20H6.5C4.567 20 3 18.433 3 16.5V13Z"
          fill="currentColor"
          opacity="0.5"
        />
